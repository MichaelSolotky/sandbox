...
\begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} c @{\extracolsep{\fill}} r}
  ...
  \faGithub \enspace \href{https://github.com/MichaelSolotky}{\color{blue} https://github.com/MichaelSolotky} && \faMobilePhone \enspace +7-967-291-0866 \\
\end{tabular*}
...
\section{Experience}
  \resumeSubHeadingListStart
      ...
      \begin{itemize}
        ...
        \item Implemented an optimal algorithm for constructing n-gram language models in C++ using MapReduce, \textbf{which surpassed baseline by up to 5 times in wall time on checked datasets and slightly in quality}
