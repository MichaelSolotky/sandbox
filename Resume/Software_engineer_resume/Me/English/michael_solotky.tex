...
\resumeSubHeadingListStart
    ...
    \vspace{-8pt}
    \begin{itemize}
      \item Support TensorFlow 2.x versions of home tasks of the Yandex's \href{https://github.com/yandexdataschool/Practical_RL}{Reinforcement Learning course}
      \item Answering questions on \href{https://math.stackexchange.com/users/721166/michael-solotky}{stack exchange} (sometimes)
    \end{itemize}
    \vspace{-12pt}
