...
\begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} c @{\extracolsep{\fill}} r}
  \faLinkedin \enspace \href{https://www.linkedin.com/in/michael-solotky/}{LinkedIn: michael-solotky}  && \faEnvelope \enspace mihlushi@yandex.com \\
\end{tabular*}
...
\section{Experience}
  \resumeSubHeadingListStart
      ...
      \begin{itemize}
        \item Finding {\bf theoretical foundations} for different methods of {\bf uncertainty estimation} in {\bf Deep Learning}
        \vspace{-2pt}
...
\resumeSubHeadingListStart
    \item{
      \textbf{\href{https://github.com/Actual-AI-Designer/Actual-AI-Designer}{Actual AI Designer} (PyTorch) -- Mentorship in a high school project}
      \hfill
      Aug 2020 -- now
    } \\
