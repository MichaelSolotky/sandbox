...
\section{Experience}
  \resumeSubHeadingListStart
            \item{
        \textbf{Research Intern at \href{https://research.yandex.com/}{\color{blue} Yandex} }%\\ Research department} %(ToDo: list of technologies)}
        \hfill
        Sep 2020 -- now \\
      }
      \vspace{-1pt}
...
\resumeSubHeadingListStart
    \item{
      \textbf{Actual AI Designer (PyTorch) -- Mentorship in a school project}
      % mb include links to some news here
      \hfill
      Aug 2020 -- now
    } \\
    A tool for automatic generating logos based on the description
    \vspace{-8pt}
    \begin{itemize}
