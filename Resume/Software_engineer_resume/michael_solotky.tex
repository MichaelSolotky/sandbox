...
\resumeSubHeadingListStart
    \item{
        {MSc student in Applied Mathematics and Informatics, GPA 3.9 / 4.0 } \\ % (9.23 / 10.0)
        \vspace{-1pt}
    ...
    \vspace{-7pt}
    \item{
        {BSc in Applied Mathematics and Computer Science, with Honours, GPA 3.89 / 4.0} \\ % (4.89 / 5.0)
        \vspace{-1pt}
