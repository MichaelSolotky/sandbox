...
\resumeSubHeadingListStart
    \item{
        {\textbf{Master of Science} in Applied Mathematics and Informatics, GPA 3.9 / 4.0 } \\ % (9.23 / 10.0)
        \vspace{-1pt}
...
\resumeSubHeadingListStart
    ...
    \item{
        \textbf{Research Science Intern at \href{https://research.yandex.com/}{\color{blue} Yandex}} \skill{PyTorch}
        \hfill
        Sep 2020 -- Jun 2021 \\
    }
    \vspace{-6pt}
    ...
    \item{
        ...
        \hfill
        Jun 2019 -- Sep 2019 \\
        \textbf{Machine Translation department} \skill{TensorFlow} \skill{MapReduce} \skill{NumPy} \skill{SciPy}
    }
    \vspace{-6pt}
    \begin{itemize}
    ...
    \item{
        ...
        \hfill
        Jun 2018 -- Oct 2018 \\
        \textbf{Voice Technology department} \skill{C\textbf{\footnotesize++}} \skill{MapReduce} \skill{Protobuf}
    }
    \vspace{-6pt}
    \begin{itemize}
