...
\resumeSubHeadingListStart
    ...
    \item{
        \textbf{Software Engineering Intern at \href{https://yandex.com/company/}{\color{blue} Yandex}}
        \hfill
        Jun 2019 -- Sep 2019 \\
...
\resumeSubHeadingListStart
    ...
    \vspace{-6pt}
    \begin{itemize}
        \item Development and support of a tool for parallel calculation of pairwise word statistics such as frequency of mutual occurrence, PMI in large text corpora in conditions of low RAM \\
