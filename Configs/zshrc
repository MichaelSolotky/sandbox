...
plugins=(git textmate macos ruby)

source $ZSH/oh-my-zsh.sh

# Customize to your needs...
# added my path 2011.7.19
export PATH=~/.local:/Users/michaelsolotky/Library/Python/3.7/bin:usr/local/bin:.local/bin:/opt:/usr/local/apache-maven-2.2.1/bin:/usr/local/maven-1.1/bin:/Developer/android/android-sdk-mac_x86/tools:/usr/local/mysql/bin:/usr/local/sbin:~/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/usr/X11/bin:/Users/mark/.rvm/bin

export ARTM_SHARED_LIBRARY="~/.bigartm_installed/lib/libartm.dylib"
...
alias lh='ls -a | egrep "^\."'
# make python 2 unreachable on this device
